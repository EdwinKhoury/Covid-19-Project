...
ORDER BY Date
--Shows the likelihood of dying if you contract COVID-19 in Lebanon.
...
WHERE location = 'Lebanon'
ORDER BY 2
--Shows what percentage of the population got COVID-19 in Lebanon. By the end of 2020, 3.24% of the Lebanese contracted the virus.
--By the end of 2021, 13.18% of the population contracted COVID-19, more than 3 times more than the previous year.
...
--Yemen, Niger, Chad, Tanzania, and Sierra Leone, have infections rate lower than 0.1% of its population: this is not because of 
...
--Africa is ranked as one of the continents with the fewest deaths with 259,006. This is due to the unavailability of medical care, and PCR test
...
GROUP BY date
ORDER BY date
--The first COVID-19 case was recorded on the 4th of January 2020, whereas the first death was reported 8 days.
--In mid-April 2020, almost 10% of the cases were fatal.
